 ...
 *
 * kWebSocket supports seek operations with respect to the stream read pointer. The stream write 
 ...
 * stream (e.g., kFile) will be reused with a kWebSocket object. Forward seek operations are relatively 
 ...
 * reverse seek, kWebSocket_SetReadBuffers must be invoked with a non-zero clientSize argument. Reverse 
...
/**
 * Returns the underlying TCP client object.
 *
 * @public              @memberof kUdpClient
 * @param   webSocket   WebSocket object.
 * @return              WebSocket client object.
 */
