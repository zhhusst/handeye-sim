...
kFx(kStatus) kPath_Plugin(const kChar* pluginName, kChar* pluginPath, kSize capacity)
{
    ...
    //Some documentation and releases specify "Tx2" instead of "Jetson". Don't break those just yet.
    //TODO: remove this hack some day.
    if (kStrEquals(pluginName, "kHardwareTx2"))
    {
        pluginName = "kHardwareJetson";
    }
