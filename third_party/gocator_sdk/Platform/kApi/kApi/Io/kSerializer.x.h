...
#define xkSERIALIZER_DEFAULT_MAX_BUFFERED_WRITE_SIZE    (2048)
...
{    
    ...
    */
    ...
    kBool objectFlushEnabled;                       //[Protected] kTRUE if a flush operation should be performed after each object is written; must be respected by descendant classes
    ...
    */
    ...
    kSize maxBufferedWriteSize;                     //[Private] max size threshold for buffered writes. 
