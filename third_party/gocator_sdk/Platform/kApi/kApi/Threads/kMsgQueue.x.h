...
#define xkMSG_QUEUE_PURGE_OPTION_COMPLETE        (0x10)       ///< Examine all items during purge; do not discontinue when capacity constraints are satisified.
...
typedef struct kMsgQueueClass
{
    ...
    kSize inbandCount;                  //current count of inband items
