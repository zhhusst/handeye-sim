...
#define kMSG_QUEUE_ITEM_OPTION_CRITICAL                     (0x1)       ///< Item should not be dropped as a result of capacity constraint violations.
#define kMSG_QUEUE_ITEM_OPTION_INBAND                       (0x2)       ///< Item should not be counted (can be added/removed/dropped, but will not be reflected in count/size/drop metrics).
/** @} */
 ...
 * @public              @memberof kMsgQueue
 * @param   queue       Queue object. 
 * @return              Count of queue items (excluding any inband items).
 */
