 ...
 *
 * @internal
 * Copyright (C) 2003-2024 by LMI Technologies Inc.
 ...
 * 
 * The file extension is used to determine to image format. The BMP (.bmp), PNG (.png) and Portable GrayMap (.pgm) formats are supported.
 *
 * @public              @memberof kImage
