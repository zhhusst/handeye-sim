 ...
 * @param   value   Value.
 * @return          kTRUE if the value is null; kFALSE otherwise.
 */
...
#define kPIXEL_FORMAT_8BPC_BGR          (6)      ///< 8-bits-per-channel color with 3 channels (blue/green/red)(kRgb24)
/** @} */
...
#define kArgb_Init_(ARGB, A, R, G, B)   \
  ...
  * @extends kValue
  * @ingroup kApi-Data
  * @brief   24-bit color pixel structure (B/G/R).
  *
  * kRgb24 supports the kdat5 and kdat6 serialization protocols.
  */
...
/**
 * Initializes a kRgb24 structure.
 *
 * @relates        kRgb24
 * @param   RGB24  Pointer to a kRgb24 structure.
 * @param   R      r field value.
 * @param   G      g field value.
 * @param   B      b field value.
 */
