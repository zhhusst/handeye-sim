...
kInlineFx(kSize) xkPoolAllocBlockHeader_Space()
{
    return kSize_Align(sizeof(xkPoolAllocBlockHeader), kALIGN_ANY);
}
...
kInlineFx(kSize) xkPoolAllocBufferHeader_Space()
{
    return kSize_Align(sizeof(xkPoolAllocBufferHeader), kALIGN_ANY);
}
...
kInlineFx(kSize) xkPoolAlloc_AllocBlockSize(kPoolAlloc object)
{
    ...
    return xkPoolAllocBlockHeader_Space() + xkPoolAlloc_BlockContentSize(object);
}
