...
ifeq ($(config),Debug)
	...
	../../build/kApi-gnumk_linux_x86-Debug/kDataTree.cpp.o \
	../../build/kApi-gnumk_linux_x86-Debug/kDataTreeItem.cpp.o \
	...
	../../build/kApi-gnumk_linux_x86-Debug/kDataTree.cpp.d \
	../../build/kApi-gnumk_linux_x86-Debug/kDataTreeItem.cpp.d \
...
ifeq ($(config),Release)
	...
	../../build/kApi-gnumk_linux_x86-Release/kDataTree.cpp.o \
	../../build/kApi-gnumk_linux_x86-Release/kDataTreeItem.cpp.o \
	...
	../../build/kApi-gnumk_linux_x86-Release/kDataTree.cpp.d \
	../../build/kApi-gnumk_linux_x86-Release/kDataTreeItem.cpp.d \
...
../../build/kApi-gnumk_linux_x86-Debug/kDataTree.cpp.o ../../build/kApi-gnumk_linux_x86-Debug/kDataTree.cpp.d: kApi/Data/kDataTree.cpp
	$(SILENT) $(info GccX86 kApi/Data/kDataTree.cpp)
	$(SILENT) $(GNU_CXX_COMPILER) $(GNU_COMPILER_FLAGS) $(CXX_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../build/kApi-gnumk_linux_x86-Debug/kDataTree.cpp.o -c kApi/Data/kDataTree.cpp -MMD -MP

../../build/kApi-gnumk_linux_x86-Debug/kDataTreeItem.cpp.o ../../build/kApi-gnumk_linux_x86-Debug/kDataTreeItem.cpp.d: kApi/Data/kDataTreeItem.cpp
	$(SILENT) $(info GccX86 kApi/Data/kDataTreeItem.cpp)
	$(SILENT) $(GNU_CXX_COMPILER) $(GNU_COMPILER_FLAGS) $(CXX_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../build/kApi-gnumk_linux_x86-Debug/kDataTreeItem.cpp.o -c kApi/Data/kDataTreeItem.cpp -MMD -MP
...
../../build/kApi-gnumk_linux_x86-Release/kDataTree.cpp.o ../../build/kApi-gnumk_linux_x86-Release/kDataTree.cpp.d: kApi/Data/kDataTree.cpp
	$(SILENT) $(info GccX86 kApi/Data/kDataTree.cpp)
	$(SILENT) $(GNU_CXX_COMPILER) $(GNU_COMPILER_FLAGS) $(CXX_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../build/kApi-gnumk_linux_x86-Release/kDataTree.cpp.o -c kApi/Data/kDataTree.cpp -MMD -MP

../../build/kApi-gnumk_linux_x86-Release/kDataTreeItem.cpp.o ../../build/kApi-gnumk_linux_x86-Release/kDataTreeItem.cpp.d: kApi/Data/kDataTreeItem.cpp
	$(SILENT) $(info GccX86 kApi/Data/kDataTreeItem.cpp)
	$(SILENT) $(GNU_CXX_COMPILER) $(GNU_COMPILER_FLAGS) $(CXX_FLAGS) $(DEFINES) $(INCLUDE_DIRS) -o ../../build/kApi-gnumk_linux_x86-Release/kDataTreeItem.cpp.o -c kApi/Data/kDataTreeItem.cpp -MMD -MP
...
include ../../build/kApi-gnumk_linux_x86-Debug/kDataTree.cpp.d
include ../../build/kApi-gnumk_linux_x86-Debug/kDataTreeItem.cpp.d
...
include ../../build/kApi-gnumk_linux_x86-Release/kDataTree.cpp.d
include ../../build/kApi-gnumk_linux_x86-Release/kDataTreeItem.cpp.d
