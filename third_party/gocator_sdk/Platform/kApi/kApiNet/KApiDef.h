    ...
    namespace Zen
    {
       ...
       /// <summary>Represents the byte-ordering of primative data types.</summary>       
        ...
        namespace Data
        {
            ...
            /// <summary>24-bit color pixel structure (B/G/R).</summary>
            [StructLayout(LayoutKind::Explicit, Size = sizeof(kRgb24))]
            public value struct KRgb24
            {
                KDeclareStruct(KRgb24, kRgb24)

                    /// <summary>Initializes a new KRgb24 instance.</summary>
                    KRgb24(k8u r, k8u g, k8u b)
                    : R(r), G(g), B(b)
                {}

                /// <summary>Blue component value.</summary>
                [FieldOffset(offsetof(kRgb24, b))]
                k8u B;

                /// <summary>Green component value.</summary>
                [FieldOffset(offsetof(kRgb24, g))]
                k8u G;

                /// <summary>Red component value.</summary>
                [FieldOffset(offsetof(kRgb24, r))]
                k8u R;
            };
            ...
            public value struct KPixelFormat
            {
                ...
                /// <summary>8-bits-per-channel color with 3 channels (blue/green/red) (KRgb32).</summary>
                literal k32s Format8bpcBgr = kPIXEL_FORMAT_8BPC_BGR;
