        ...
        {           
            ...
            public:
                ...
                void Remove(KEventFx^ handler)
                {
                    ...
                    // The "if (1)" is used to silence a VS2022 (17.1) warning.
                    // VS2022 17.2.0 Preview 2.1 fixes this bug; so we can likely remove this line later.
                    // See: MicroSoft bug 1441026.
                    if (1)
