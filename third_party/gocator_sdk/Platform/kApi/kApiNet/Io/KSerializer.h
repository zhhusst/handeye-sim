    ...
    namespace Zen 
    {
        namespace Io
        {
            ...
            public:
                ...
                /// <summary>Writes a number of (zero) bytes.</summary>
                /// 
                /// <param name="offset">Number of bytes to write.</param>
                void AdvanceWrite(k64s offset)
                {
                    KCheck(kSerializer_AdvanceWrite(Handle, (kSize)offset)); 
                }
