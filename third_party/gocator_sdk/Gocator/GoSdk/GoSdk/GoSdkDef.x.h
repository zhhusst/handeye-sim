...
#define GO_SDK_PROTOCOL_VERSION    "101.22.0.0"
...
kDeclareEnumEx(Go, GoPreFilterType, kValue)
kDeclareEnumEx(Go, GoPreFilterLengthOption, kValue)
...
#define GO_ACCELERATOR_EVENT_SET_TIME_DATE      0x1009  // event to indicate the system is ready for the time and date to be set.
