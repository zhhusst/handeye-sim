...
kBeginEnumEx(Go, GoAlignmentStatus)
    ...
    kAddEnumerator(GoAlignmentStatus, GO_ALIGNMENT_STATUS_TOO_FEW_PROFILES)
...
kBeginEnumEx(Go, GoPreFilterType)
    kAddEnumerator(GoPreFilterType, GO_PREFILTER_TYPE_BOX)
    kAddEnumerator(GoPreFilterType, GO_PREFILTER_TYPE_GAUSSIAN)
    kAddEnumerator(GoPreFilterType, GO_PREFILTER_TYPE_CUSTOM)
kEndEnumEx()

kBeginEnumEx(Go, GoPreFilterLengthOption)
    kAddEnumerator(GoPreFilterLengthOption, GO_PREFILTER_LENGTH_OPTION_3)
    kAddEnumerator(GoPreFilterLengthOption, GO_PREFILTER_LENGTH_OPTION_5)
    kAddEnumerator(GoPreFilterLengthOption, GO_PREFILTER_LENGTH_OPTION_7)
    kAddEnumerator(GoPreFilterLengthOption, GO_PREFILTER_LENGTH_OPTION_9)
    kAddEnumerator(GoPreFilterLengthOption, GO_PREFILTER_LENGTH_OPTION_11)
    kAddEnumerator(GoPreFilterLengthOption, GO_PREFILTER_LENGTH_OPTION_13)
kEndEnumEx()
