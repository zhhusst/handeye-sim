 ...
 *
 * @li                  GO_SENSOR_LIVE_JOB      - Represents "_live.job".
 ...
 * Calling this function will turn the laser on or off.
 *
 * @public              @memberof GoSensor
 * @version             Introduced in firmware 6.2.26.2
 * @param   sensor      GoSensor object.
 * @param   enable      State of laser to set if enable > 0, reset if enable = 0
 * @return              Operation status.
 */
GoFx(kStatus) GoSensor_SetLaserState(GoSensor sensor, k8u enable);

/**
 * Turns off the sensor. Sensor will not restart until it is powercycled.
 *
 * @public              @memberof GoSensor
 ...
 * This is currently only supported on battery-powered sensors.
 *
 * @public              @memberof GoSensor
 * @version             Introduced in firmware 6.4.39.2
 * @param   sensor      GoSensor object.
 * @param   shouldLock  Locks out the laser if not 0. Unlocks it if 0.
 * @return              Operation status.
 */
