...
/**
 * @struct  GoPreFilterType
 * @extends kValue
 * @ingroup GoSdk
 * @brief   Represents a prefilter type.
 *
 * The following enumerators are defined:
 * - #GO_PREFILTER_TYPE_BOX
 * - #GO_PREFILTER_TYPE_GAUSSIAN
 * - #GO_PREFILTER_TYPE_CUSTOM
 */
typedef k32s GoPreFilterType;
/** @name    GoPreFilterType
 *@{*/
#define GO_PREFILTER_TYPE_BOX           (0)  ///< Box prefilter type (with fixed 3, 5, 9, 11 or 13 coefficient values).
#define GO_PREFILTER_TYPE_GAUSSIAN      (1)  ///< Gaussian prefilter type (with fixed 3, 5, 9, 11 or 13 coefficient values).
#define GO_PREFILTER_TYPE_CUSTOM        (2)  ///< Custom prefilter where user specifies up to GoPreFilterLengthOption prefilter coefficients.
/**@}*/

/**
 * @struct  GoPreFilterLengthOption
 * @extends kValue
 * @ingroup GoSdk
 * @brief   Represents the choices of the filter length (ie. how many prefilter coefficients to use for the prefilter).
 *
 * The following enumerators are defined:
 * - #GO_PREFILTER_LENGTH_OPTION_3
 * - #GO_PREFILTER_LENGTH_OPTION_5
 * - #GO_PREFILTER_LENGTH_OPTION_7
 * - #GO_PREFILTER_LENGTH_OPTION_9
 * - #GO_PREFILTER_LENGTH_OPTION_11
 * - #GO_PREFILTER_LENGTH_OPTION_13
 */
typedef k32s GoPreFilterLengthOption;
/** @name    GoPreFilterLengthOption
 *@{*/
#define GO_PREFILTER_LENGTH_OPTION_3            (3)     ///< Use a prefilter with 3 prefilter coefficients.
#define GO_PREFILTER_LENGTH_OPTION_5            (5)     ///< Use a prefilter with 5 prefilter coefficients.
#define GO_PREFILTER_LENGTH_OPTION_7            (7)     ///< Use a prefilter with 7 prefilter coefficients.
#define GO_PREFILTER_LENGTH_OPTION_9            (9)     ///< Use a prefilter with 9 prefilter coefficients.
#define GO_PREFILTER_LENGTH_OPTION_11           (11)    ///< Use a prefilter with 11 prefilter coefficients.
#define GO_PREFILTER_LENGTH_OPTION_13           (13)    ///< Use a prefilter with 13 prefilter coefficients.
/**@}*/

// GOC-15006 - Increase the maximum number of prefilter coefficients from 5 to 13.
#define GO_PREFILTER_MAX_NUM_COEFF_IN_FILTER        (GO_PREFILTER_LENGTH_OPTION_13) ///< Maximum number of coefficients a filter can have.

/**
 * @name  GoPreFilterCoefficient
 * @extends kValue
 * @ingroup GoSdk
 * @brief   Represents a prefilter coefficient value type.
 */
typedef k64f GoPreFilterCoefficient;
 ...
 * @extends kValue
 * @ingroup GoSdk
 * @brief   Represents an HDR mode.
 *
 * The following enumerators are defined:
 * - #GO_HDR_MODE_DISABLED
 * - #GO_HDR_MODE_GAMMA
 */
typedef k32s GoHdrMode;
/** @name    GoHdrMode
 *@{*/
#define GO_HDR_MODE_DISABLED       (0)  ///< HDR mode disabled.
#define GO_HDR_MODE_GAMMA          (1)  ///< HDR mode set to Gamma Compression
 /**@}*/
 ...
 * @extends kValue
 * @ingroup GoSdk
 * @brief   Represents the operation status of an alignment. GoAlignmentStatus is an extension
 *          from kStatus, so it includes all of the status codes in kStatus.
 *
 * The following enumerators are defined:
 ...
 * - #GO_ALIGNMENT_STATUS_TOO_FEW_PROFILES
...
#define GO_ALIGNMENT_STATUS_TOO_FEW_PROFILES                (-7)                ///< The number of profiles are smaller than the minimal number of profiles needed, please ensure that there are enough profiles.
...
// Default min/max for the transmit limit GoSetup setting.
#define GO_TRANSMIT_RATE_PERCENT_MIN            (1)
#define GO_TRANSMIT_RATE_PERCENT_MAX            (100)
