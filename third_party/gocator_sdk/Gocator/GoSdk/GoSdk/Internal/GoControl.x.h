...
#define GO_CONTROL_SET_LASER_STATE                  (0x4544)
#define GO_CONTROL_SET_LASER_STATE_TIMEOUT          (1000000)
...
#define GO_CONTROL_SHUTDOWN                         (0x4611)
#define GO_CONTROL_SHUTDOWN_TIMEOUT                 (3000000)

#define GO_CONTROL_SET_LASER_LOCKOUT                (0x4612)
#define GO_CONTROL_LASER_LOCKOUT_TIMEOUT            (1000000)
