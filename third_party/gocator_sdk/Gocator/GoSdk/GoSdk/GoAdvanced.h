...
/**
 * Returns the High Dynamic Range mode setting.
 *
 * @public             @memberof GoAdvanced
 * @version            Introduced in firmware 6.3.1.83
 * @note               Not available on all sensors. Use GoAdvanced_IsHdrModeUsed()
 *                     to determine if this feature is supported on sensor.
 * @param   advanced   GoAdvanced object.
 * @return             The High Dynamic Range mode.
 */
GoFx(GoHdrMode) GoAdvanced_HdrMode(GoAdvanced advanced);

/**
 * Sets the High Dynamic Range mode setting.
 ...
 *                     to determine if this feature is supported on sensor.
 * @param   advanced   GoAdvanced object.
 * @param   mode       High Dynamic Range mode.
 * @return             Operation status.
*/
...
/**
 * Returns the High Dynamic Range mode options count.
 *
 * @public             @memberof GoAdvanced
 * @version            Introduced in firmware 6.3.1.83
 * @note               Not available on all sensors. Use GoAdvanced_IsHdrModeUsed()
 *                     to determine if this feature is supported on sensor.
 * @param   advanced   GoAdvanced object.
 * @return             The High Dynamic Range mode options count.
 */
 ...
 *                     to determine if this feature is supported on sensor.
 * @param   advanced   GoAdvanced object.
 * @param   index      The parameter list index to access.
 * @return             The parameter value at the given index used for the current High Dynamic Range
 *                     mode set. But if the index exceeds the bounds of the list, 0 is returned.
 */
...
*                      to determine if this feature is supported on sensor.
* @param   advanced    GoAdvanced object.
* @param   index       The parameter  list index to be updated.
* @param   hdrParameter Parameter value to be updated.
* @return              Operation status.
*/
...
/**
 * Returns the High Dynamic Range parameters count.
 *
 * @public             @memberof GoAdvanced
 * @version            Introduced in firmware 6.3.1.83
 * @note               Not available on all sensors. Use GoAdvanced_IsHdrModeUsed()
 *                     to determine if this feature is supported on sensor.
 * @param   advanced   GoAdvanced object.
 * @return             The count of High Dynamic Range parameters.
 */
GoFx(kSize) GoAdvanced_HdrParametersCount(GoAdvanced advanced);

/**
 * Returns the High Dynamic Range parameters minimum count required.
 *
 * @public             @memberof GoAdvanced
 * @version            Introduced in firmware 6.3.1.83
 * @note               Not available on all sensors. Use GoAdvanced_IsHdrModeUsed()
 *                     to determine if this feature is supported on sensor.
 * @param   advanced   GoAdvanced object.
 * @return             The minimum number of High Dynamic Range parameters expected.
 */
GoFx(kSize) GoAdvanced_HdrParametersCountMin(GoAdvanced advanced);

/**
 * Returns the High Dynamic Range parameters maximum count allowed.
 *
 * @public             @memberof GoAdvanced
 * @version            Introduced in firmware 6.3.1.83
 * @note               Not available on all sensors. Use GoAdvanced_IsHdrModeUsed()
 *                     to determine if this feature is supported on sensor.
 * @param   advanced   GoAdvanced object.
 * @return             The maximum number of High Dynamic Range parameters expected.
 */
GoFx(kSize) GoAdvanced_HdrParametersCountMax(GoAdvanced advanced);

/**
 * Returns the High Dynamic Range parameters minimum value.
 *
 * @public             @memberof GoAdvanced
 * @version            Introduced in firmware 6.3.1.83
 * @note               Not available on all sensors. Use GoAdvanced_IsHdrModeUsed()
 *                     to determine if this feature is supported on sensor.
 * @param   advanced   GoAdvanced object.
 * @return             The minimum value for each High Dynamic Range parameter.
 */
GoFx(k64f) GoAdvanced_HdrParametersValueMin(GoAdvanced advanced);

/**
 * Returns the High Dynamic Range parameters maximum value.
 *
 * @public             @memberof GoAdvanced
 * @version            Introduced in firmware 6.3.1.83
 * @note               Not available on all sensors. Use GoAdvanced_IsHdrModeUsed()
 *                     to determine if this feature is supported on sensor.
 * @param   advanced   GoAdvanced object.
 * @return             The maximum value for each High Dynamic Range parameter.
 */
GoFx(k64f) GoAdvanced_HdrParametersValueMax(GoAdvanced advanced);

/**
 * Returns whether the intensity compatibilty is needed or applicable for this device.
 *
 * The projector intensity compatibility mode refers to the projector intensity compatibility
 * feature for some newer G3 projector hardware to make the newer projector intensity
 * compatible with older versions of G3 projector hardware.
 * This capability only applies to G3 models which were made with older projector hardware
 * such as the G3210, G3506.
 *
 * @public             @memberof GoAdvanced
 * @version            Introduced in firmware 6.3.1.83
 * @note               Supported by G3210, G3506 hardware revision B.
 * @param   advanced   GoAdvanced object.
 * @return             kTRUE if the projector intensity compatibility is needed/applicable for this device.
 *                     kFALSE otherwise
 */
GoFx(kBool) GoAdvanced_IntensityCompatibilityModeEnabled(GoAdvanced advanced);

/**
 * Returns indication whether the intensity compatibilty feature is enabled or not.
 *
 ...
 * @note               Supported by G3210, G3506 hardware revision B.
 * @param   advanced   GoAdvanced object.
 * @return             kTRUE if the projector intensity of the newer projector hardware
 *                     is to be the compatible with the projector intensity of the older
 *                     projector hardware.
 *                     kFALSE if the projector intensity of the new projector is to operate
 ...
 * Setting the compatibility mode to kTRUE makes the newer hardware projector intensity
 * compatibile with the older hardware projector intensity.
 * Setting the mode to kFALSE turns this off and allows the newer hardware projector
 * to operate at full intensity.
 *
 * This API is only meaningful if GoAdvanced_IntensityCompatibilityModeEnabled() return kTRUE.
 *
 * @public             @memberof GoAdvanced
 ...
 * @note               Supported by G3210, G3506 hardware revision B.
 * @param   advanced   GoAdvanced object.
 * @param   state      Set to kTRUE to enable projector intensity compatibility. Set to kFALSE to disable it.
 * @return             Operation status.
 */
