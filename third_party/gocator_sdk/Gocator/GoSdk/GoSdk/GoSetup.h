 ...
 * @public              @memberof GoSetup
 * @version             Introduced in firmware 6.4.39.2
 * @param   setup       GoSetup object.
 * @param   limit       New transmit limit to use.
 * @return              Operation status.
 */
 ...
 * @version             Introduced in firmware 4.0.10.27
 * @param   setup       GoSetup object.
 * @return              Currently configured frame rate (Hz).
 */
 ...
 *
 * @public                        @memberof GoSetup
 * @version                       Introduced in firmware 6.3.1.83
 * @param   setup                 GoSetup object.
 * @param   role                  Determines which device to retrieve the value from. Use GO_ROLE_MAIN or GOROLE_BUDDYIDX(buddyidx). See GoRole for more details.
 * @return                        kTRUE if enhanced surface flatness filtering is support, otherwise kFALSE is returned.
 */
 ...
 * If enhanced surface flatness filtering is not supported an error code will be returned.
 * 
 * @public                        @memberof GoSetup
 * @version                       Introduced in firmware 6.4.39.2
 * @param   setup                 GoSetup object.
 * @param   role                  Determines which device to retrieve the value from. Use GO_ROLE_MAIN or GOROLE_BUDDYIDX(buddyidx). See GoRole for more details.
 * @param   enable                Whether to enable or disable enhanced surface flatness.
 * @return                        Operation status.
 */
 ...
 * @param   setup                 GoSetup object.
 * @param   role                  Determines which device to retrieve the value from. Use GO_ROLE_MAIN or GOROLE_BUDDYIDX(buddyidx). See GoRole for more details.
 * @param   type                  Prefilter type other than GO_PREFILTER_TYPE_CUSTOM.
 * @param   length                The number of filter coefficients to use in the specified enhanced surface flatness filter mode.
 * @return                        Operation status.
 */
 ...
 *
 * The number of coefficients in the input array "coefficientsArray" MUST be equal to "length" parameter. This is the
 * responsibility of the caller. The API cannot know if the input array is too small, resulting in accessing memory outside
 * of the actual array, possibly leading to unpredictable behaviour.
 *
 * Each coefficient value must be with the range of the minimum and maximum allowable values given by
 * GoSetup_CoefficientMinValue() and GoSetup_CoefficientMaxValue().
 * The sum of all the coefficient values must be equal to GoSetup_CoefficientsExpectedSum().
 *
 * NOTE: because of the inherent limitations of exactly representing a floating point number, the above comparisons to the limits
 *       cannot be exact.
 *
 * @public                        @memberof GoSetup
 * @version                       Introduced in firmware 6.3.1.83
 * @param   setup                 GoSetup object.
 * @param   role                  Determines which device to retrieve the value from. Use GO_ROLE_MAIN or GOROLE_BUDDYIDX(buddyidx). See GoRole for more details.
 * @param   length                The number of filter coefficients to use in the custom enhanced surface flatness filter.
 * @param   coefficientsArray     An input array of enhanced surface flatness filter coefficients to use. Number of entries MUST be equal to length.
 * @return                        Operation status.
 */
 ...
 * @param   setup                 GoSetup object.
 * @param   role                  Determines which device to retrieve the value from. Use GO_ROLE_MAIN or GOROLE_BUDDYIDX(buddyidx). See GoRole for more details.
 * @return                        Whether enhanced surface flatness is enabled or not.
 */
GoFx(kBool) GoSetup_EnhancedSurfaceFlatnessFilterEnabled(GoSetup setup, GoRole role);

/**
 * Gets the enhanced surface flatness filter type, if device supports enhanced surface flatness filtering.
 * Check that the device supports it by calling GoSetup_IsEnhancedSurfaceFlatnessFilterSupported().
 *
 * @public                        @memberof GoSetup
 * @version                       Introduced in firmware 6.3.1.83
 * @param   setup                 GoSetup object.
 * @param   role                  Determines which device to retrieve the value from. Use GO_ROLE_MAIN or GOROLE_BUDDYIDX(buddyidx). See GoRole for more details.
 * @return                        The enhanced surface flatness filter type currently selected.
 */
GoFx(GoPreFilterType) GoSetup_EnhancedSurfaceFlatnessFilterType(GoSetup setup, GoRole role);

/**
 * Gets the enhanced surface flatness filter length selected, if device supports enhanced surface flatness filtering.
 * Check that the device supports it by calling GoSetup_IsEnhancedSurfaceFlatnessFilterSupported().
 *
 * @public                        @memberof GoSetup
 * @version                       Introduced in firmware 6.3.1.83
 * @param   setup                 GoSetup object.
 * @param   role                  Determines which device to retrieve the value from. Use GO_ROLE_MAIN or GOROLE_BUDDYIDX(buddyidx). See GoRole for more details.
 * @return                        Returns the length of the enhanced surface flatness filter that was selected.
 */
 ...
 * Check that the device supports it by calling GoSetup_IsEnhancedSurfaceFlatnessFilterSupported().
 *
 * The coefficients returned is for the currently selected enhanced surface flatness filter mode. The number of coefficients is
 * the value of GoPreFilterLengthOption in the GoSetup_SelectBuiltInEnhancedSurfaceFlatnessFilter() or
 * GoSetup_SelectCustomEnhancedSurfaceFlatnessFilter() API calls.
 *
 * @public                        @memberof GoSetup
 * @version                       Introduced in firmware 6.3.1.83
 * @param   setup                 GoSetup object.
 * @param   role                  Determines which device to retrieve the value from. Use GO_ROLE_MAIN or GOROLE_BUDDYIDX(buddyidx). See GoRole for more details.
 * @return                        Output array of coefficients which is filled with the enhanced surface flatness filter coefficients in use.
 *                                The number of entries is the same as the GoPreFilterLengthOption parameter used to configure the enhanced surface flatness filter.
 */
GoFx(const GoPreFilterCoefficient*) GoSetup_EnhancedSurfaceFlatnessFilterCoefficients(GoSetup setup, GoRole role);

/**
 * Gets the smallest allowable enhanced surface flatness filter coefficient. This value is meaningful only if device supports enhanced surface flatness filtering.
 * Check that the device supports it by calling GoSetup_IsEnhancedSurfaceFlatnessFilterSupported().
 *
 ...
 * @param   setup                 GoSetup object.
 * @param   role                  Determines which device to retrieve the value from. Use GO_ROLE_MAIN or GOROLE_BUDDYIDX(buddyidx). See GoRole for more details.
 * @return                        Smallest allowable enhanced surface flatness filter coefficient for use in a enhanced surface flatness filter.
 */
GoFx(k64f) GoSetup_EnhancedSurfaceFlatnessFilterCoefficientMinValue(GoSetup setup, GoRole role);

/**
 * Gets the largest allowable enhanced surface flatness filter coefficient. This value is meaningful only if device supports enhanced surface flatness filtering.
 * Check that the device supports it by calling GoSetup_IsEnhancedSurfaceFlatnessFilterSupported().
 *
 * This is the largest enhanced surface flatness filter coefficient value that can be used for a enhanced surface flatness filter.
 *
 * @public                        @memberof GoSetup
 * @version                       Introduced in firmware 6.3.1.83
 * @param   setup                 GoSetup object.
 * @param   role                  Determines which device to retrieve the value from. Use GO_ROLE_MAIN or GOROLE_BUDDYIDX(buddyidx). See GoRole for more details.
 * @return                        Largest allowable enhanced surface flatness filter coefficient for use in a enhanced surface flatness filter.
 */
GoFx(k64f) GoSetup_EnhancedSurfaceFlatnessFilterCoefficientMaxValue(GoSetup setup, GoRole role);

/**
 * Gets the expected value of the sum of all the enhanced surface flatness filter coefficients. This value is meaningful only if device supports enhanced surface flatness filtering.
 * Check that the device supports it by calling GoSetup_IsEnhancedSurfaceFlatnessFilterSupported().
 *
 ...
 * @param   setup                 GoSetup object.
 * @param   role                  Determines which device to retrieve the value from. Use GO_ROLE_MAIN or GOROLE_BUDDYIDX(buddyidx). See GoRole for more details.
 * @return                        The expected sum of all the coefficients used in a enhanced surface flatness filter.
 */
...
/**
 * Returns whether the value used for the x-resolution divider is the one set by the user or the system default value.
 *
 * @public              @memberof GoSetup
 * @version             Introduced in firmware 6.3.1.83
 * @param   setup       GoSetup object.
 * @param   role        Determines which device to retrieve the value from. Use GO_ROLE_MAIN or GOROLE_BUDDYIDX(buddyidx). See GoRole for more details.
 * @return              kTRUE if the user value is used and kFALSE if system default is used.
 */
 ...
 * @param   setup       GoSetup object.
 * @param   role        Determines which device to retrieve the value from. Use GO_ROLE_MAIN or GOROLE_BUDDYIDX(buddyidx). See GoRole for more details.
 * @return              X resolution divider (e.g. 1 - full res, 2 - half res) system value.
 */
 ...
 *
 * Note: Not all sensors will support a default x-resolution divider. If available, this
 * function indicates whether the current sensor has a default value.
 *
 *
 * @public              @memberof GoSetup
 * @version             Introduced in firmware 6.3.1.83
 * @param   setup       GoSetup object.
 * @param   role        Determines which device to retrieve the value from. Use GO_ROLE_MAIN or GOROLE_BUDDYIDX(buddyidx). See GoRole for more details.
 * @return              kTRUE if a default divider is available and kFALSE if not available.
 */
 ...
 *
 * Note: Not all sensors will support a default x-resolution divider. If available as indicated
 * by GoSetup_XSubsamplingDefaultEnabledUsed(), this function allows the mode to be switched from
 * either Default (true) or a Custom (false) mode.
 *
 * @public                  @memberof GoSetup
 * @version             Introduced in firmware 6.3.1.83
 * @param   setup           GoSetup object.
 * @param   role            Determines which device to apply changes to. Use GO_ROLE_MAIN or GOROLE_BUDDYIDX(buddyidx). See GoRole for more details.
 * @param   useDefault      Determines whether to use the Default x-resolution divider (true) or Custom one set by the user (false).
 * @return                  Operation status.
 */
 ...
 *
 * Note: Not all sensors will support a default x-resolution divider. If available as indicated
 * by GoSetup_XSubsamplingDefaultEnabledUsed(), this function returns the current mode set.
 *
 * @public              @memberof GoSetup
 * @version             Introduced in firmware 6.3.1.83
 * @param   setup       GoSetup object.
 * @param   role        Determines which device to retrieve the value from. Use GO_ROLE_MAIN or GOROLE_BUDDYIDX(buddyidx). See GoRole for more details.
 * @return              Indicates whether the default x-resolution divider mode is set to Default (kTRUE) or Custom (kFALSE).
 */
 ...
 * @param   setup       GoSetup object.
 * @param   role        Determines which device to retrieve the value from. Use GO_ROLE_MAIN or GOROLE_BUDDYIDX(buddyidx). See GoRole for more details.
 * @return              Z resolution divider (e.g. 1 - full res, 2 - half res) system value.
 */
 ...
 *
 * Note: Not all sensors will support a default z-resolution divider. If available, this
 * function indicates whether the current sensor has a default value.
 *
 * @public              @memberof GoSetup
 * @version             Introduced in firmware 6.3.1.83
 ...
 *
 * Note: Not all sensors will support a default z-resolution divider. If available as indicated
 * by GoSetup_ZSubsamplingDefaultEnabledUsed(), this function allows the mode to be switched from
 * either Default (true) or a Custom (false) mode.
 *
 * @public                  @memberof GoSetup
 * @version             Introduced in firmware 6.3.1.83
 * @param   setup           GoSetup object.
 * @param   role            Determines which device to apply changes to. Use GO_ROLE_MAIN or GOROLE_BUDDYIDX(buddyidx). See GoRole for more details.
 * @param   useDefault      Determines whether to use the Default z-resolution divider (true) or Custom one set by the user (false).
 * @return                  Operation status.
 */
 ...
 * @param   setup       GoSetup object.
 * @param   role        Determines which device to retrieve the value from. Use GO_ROLE_MAIN or GOROLE_BUDDYIDX(buddyidx). See GoRole for more details.
 * @return              Indicates whether the default z-resolution divider mode is set to Default (kTRUE) or Custom (kFALSE).
 */
