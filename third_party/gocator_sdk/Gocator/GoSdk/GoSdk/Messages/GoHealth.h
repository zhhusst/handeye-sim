...
#define GO_HEALTH_LASER_DRIVER_ERROR                   (20018)     ///< Laser driver error indicating whether there are errors with laser driver. Only applicable to LD16/18
...
#define GO_HEALTH_BATTERY_REMAINING_CHARGE             (3104)      ///< Percentage charge remaining for the battery.
#define GO_HEALTH_BATTERY_OPERATING_TIME               (3105)      ///< Remaining operating time for battery in hours.
#define GO_HEALTH_BATTERY_STATE_OF_HEALTH              (3106)      ///< How much charge can the battery hold relative to when it was brand new, as a percentage.
#define GO_HEALTH_BATTERY_ALARM_STATUS                 (3107)      ///< Represents battery-related alarm status.
