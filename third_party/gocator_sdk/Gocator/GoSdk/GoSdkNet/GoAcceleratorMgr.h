    ...
    namespace GoSdk
    {
        namespace AcceleratorMgr
        {
            ...
            public ref class GoAcceleratorMgr : public KObject
            {
                ...
                /// <summary>Checks whether default Gocator accelerator logger is enabled.</summary>
                KBool IsLoggingEnabled()
                {
                    return (KBool(::GoAcceleratorMgr_IsLoggingEnabled(Handle)));
                }

                /// <summary>Enables default Gocator accelerator logger.</summary>
                void EnableLogging(KBool enabled)
                {
                    KCheck(::GoAcceleratorMgr_EnableLogging(Handle, (kBool)enabled));
                }
