...
namespace Lmi3d
{
    namespace GoSdk
    {
        ...
        public ref class GoAdvanced : public KObject
        {
            ...
            /// <summary>The High Dynamic Range mode setting.</summary>
            property GoHdrMode HdrMode
            {
                GoHdrMode get()             { return ::GoAdvanced_HdrMode(Handle); }
                void set(GoHdrMode mode)    { KCheck(::GoAdvanced_SetHdrMode(Handle, mode)); }
            }

            /// <summary>A boolean representing if High Dynamic Range mode is in use.</summary>
            property bool IsHdrModeUsed
            {
                bool get() { return ::GoAdvanced_IsHdrModeUsed(Handle); }
            }

            /// <summary>The High Dynamic Range mode options count.</summary>
            property k64s HdrModeOptionCount
            {
                k64s get() { return ::GoAdvanced_HdrModeOptionCount(Handle); }
            }

            /// <summary>The value of the HDR parameter list at the given index.</summary>
            k64f GetHdrParameters(k32u index)
            {
                return ::GoAdvanced_HdrParameters(Handle, index);
            }

            /// <summary>Sets the High Dynamic Range parameter value at the index provided.</summary>
            void SetHdrParameters(k32u index, k64f hdrParameter)
            {
                return KCheck(::GoAdvanced_SetHdrParameters(Handle, index, hdrParameter));
            }

            /// <summary>A boolean representing if High Dynamic Range parameters are in use.</summary>
            property bool IsHdrParametersUsed
            {
                bool get() { return ::GoAdvanced_IsHdrParametersUsed(Handle); }
            }
            /// <summary>The High Dynamic Range parameters count.</summary>
            property k64s HdrParameterCount
            {
                k64s get() { return ::GoAdvanced_HdrParametersCount(Handle); }
            }

            /// <summary>The High Dynamic Range parameters minimum count required.</summary>
            property k64s HdrParameterCountMin
            {
                k64s get() { return ::GoAdvanced_HdrParametersCountMin(Handle); }
            }

            /// <summary>The High Dynamic Range parameters maximum count allowed.</summary>
            property k64s HdrParametersCountMax
            {
                k64s get() { return ::GoAdvanced_HdrParametersCountMax(Handle); }
            }

            /// <summary>The High Dynamic Range parameters minimum value.</summary>
            property k64f HdrParametersValueMin
            {
                k64f get() { return ::GoAdvanced_HdrParametersValueMin(Handle); }
            }

            /// <summary>The High Dynamic Range parameters maximum value.</summary>
            property k64f HdrParametersValueMax
            {
                k64f get() { return ::GoAdvanced_HdrParametersValueMax(Handle); }
            }


            /// <summary>The projector intensity compatibility mode refers to the projector intensity compatibility
            ...
            /// Setting the compatibility mode to "true" makes the newer hardware projector intensity
            /// compatibile with the older hardware projector intensity.
            /// Setting the mode to "false" turns this off and allows the newer hardware projector
            /// to operate at full intensity.</summary>
            property bool IntensityCompatibilityMode
            {
                bool get() { return KToBool(::GoAdvanced_IntensityCompatibilityMode(Handle)); }
                void set(bool value) { KCheck(::GoAdvanced_SetIntensityCompatibilityMode(Handle, value)); }
            }

            /// <summary>Returns whether the project intensity compatibility feature is
            /// available/applicable for the sensor device.
            /// If the device doesn't require/support compatibility, this call returns "false".
            /// A "true" means the device supports projector intensity compatibility.</summary>
            property bool IsIntensityCompatibilityModeEnabled
            {
                bool get() { return KToBool(::GoAdvanced_IntensityCompatibilityModeEnabled(Handle)); }
            }
