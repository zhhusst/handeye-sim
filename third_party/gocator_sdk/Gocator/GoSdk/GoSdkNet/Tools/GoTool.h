    ...
    namespace GoSdk
    {
        namespace Tools
        {
            ...
            public:
                ...
                /// </summary>
                /// <returns>True if the given tool is a GoExtTool or a subclass of it. False if it's a different kind of tool.</returns>
                virtual bool IsGoExtTool()
                {
                    return KToBool(GoTool_IsGoExtTool(Handle));
                }
