...
namespace Lmi3d
{
    namespace GoSdk
    {
        ...
        public value struct GoState
        {
            ...
            /// <summary>Sensor connected, but communication aborted via GoSensor_Cancel function (disconnect or refresh sensor).</summary>
        ...
        public value struct GoEncoderSpacingMinSource
        {
            ...
            /// <summary>Limited by part detection resolution.</summary>
        ...
        /// <summary>Represents all possible prefilter modes.</summary>
        public value struct GoPreFilterType
        {
            KDeclareEnum(GoPreFilterType, ::GoPreFilterType)

            /// <summary>Box prefilter mode.</summary>
            literal k32s Box = GO_PREFILTER_TYPE_BOX;

            /// <summary>Gaussian prefilter mode.</summary>
            literal k32s Gaussian = GO_PREFILTER_TYPE_GAUSSIAN;

            /// <summary>Custom prefilter mode.</summary>
            literal k32s Custom = GO_PREFILTER_TYPE_CUSTOM;
        };

        /// <summary>Represents all possible options for the number of coefficients used by the prefilter.</summary>
        public value struct GoPreFilterLengthOption
        {
            KDeclareEnum(GoPreFilterLengthOption, ::GoPreFilterLengthOption)

            /// <summary>Prefilter uses 3 coefficients.</summary>
            literal k32s Coefficents3 = GO_PREFILTER_LENGTH_OPTION_3;

            /// <summary>Prefilter uses 5 coefficients.</summary>
            literal k32s Coefficents5 = GO_PREFILTER_LENGTH_OPTION_5;

            /// <summary>Prefilter uses 7 coefficients.</summary>
            literal k32s Coefficents7 = GO_PREFILTER_LENGTH_OPTION_7;

            /// <summary>Prefilter uses 9 coefficients.</summary>
            literal k32s Coefficents9 = GO_PREFILTER_LENGTH_OPTION_9;

            /// <summary>Prefilter uses 11 coefficients.</summary>
            literal k32s Coefficents11 = GO_PREFILTER_LENGTH_OPTION_11;

            /// <summary>Prefilter uses 13 coefficients.</summary>
            literal k32s Coefficents13 = GO_PREFILTER_LENGTH_OPTION_13;
        };
        ...
        public value struct GoAlignmentDegreesOfFreedom
        {
            ...
            literal k32s DOF_None = GO_ALIGNMENT_DOF_NONE;

            /// <summary>3 degrees of freeedom.</summary>
            literal k32s DOF3_XZ_Y = GO_ALIGNMENT_3DOF_XZ_Y;

            /// <summary>4 degrees of freedom.</summary>
            literal k32s DOF4_XYZ_Y = GO_ALIGNMENT_4DOF_XYZ_Y;

            /// <summary>5 degrees of freedom.</summary>
            literal k32s DOF5_XYZ_YZ = GO_ALIGNMENT_5DOF_XYZ_YZ;

            /// <summary>6 degrees of freedom.</summary>
            literal k32s DOF6_XYZ_XYZ = GO_ALIGNMENT_6DOF_XYZ_XYZ;
        };
        ...
        public value struct GoDataMessageType
        {
            ...
            /// <summary>Point Feature message type.</summary>
            literal k32s FeaturePoint = GO_DATA_MESSAGE_TYPE_FEATURE_POINT;

            /// <summary>Line Feature message type.</summary>
            literal k32s FeatureLine = GO_DATA_MESSAGE_TYPE_FEATURE_LINE;

            /// <summary>Plane Feature message type.</summary>
            literal k32s FeaturePlane = GO_DATA_MESSAGE_TYPE_FEATURE_PLANE;

            /// <summary>Circle Feature message type.</summary>
            literal k32s FeatureCircle = GO_DATA_MESSAGE_TYPE_FEATURE_CIRCLE;
        ...
        /// <summary>Represents the operation status of an alignment. It is an extension of KStatus, so it includes all of the status codes in KStatus.</summary>
        public value struct GoAlignmentStatus
        {
            ...
            /// <summary>The number of profiles are smaller than the minimal number of profiles needed, please ensure that there are enough profiles.</summary>
            literal k32s TooFewProfiles = GO_ALIGNMENT_STATUS_TOO_FEW_PROFILES;
        ...
        /// <summary>Represents the power supply voltage to which the LMI device is connected.</summary>
        public value struct GoVoltageSetting
        {
            KDeclareEnum(GoVoltageSetting, ::GoVoltageSetting)

            /// <summary>LMI device is connected to a 48 Volt power supply.</summary>
            literal k16u VOLTAGE_48 = GO_VOLTAGE_48;

            /// <summary>LMI device is connected to a 24 Volt power supply.</summary>
            literal k16u VOLTAGE_24 = GO_VOLTAGE_24;
        };

        /// <summary>Represents the operating mode of a device as seen by the Gocator discovery protocol.</summary>
        public value struct GoDiscoveryOpMode
        {
            KDeclareEnum(GoDiscoveryOpMode, ::GoDiscoveryOpMode)

            /// <summary>Discovery protocol was unable to discover the device.</summary>
            literal k32s NOT_AVAILABLE  = GO_DISCOVERY_OP_MODE_NOT_AVAILABLE;

            /// <summary>Discovery protocol has determined the device is a physical device.</summary>
            literal k32s STANDALONE     = GO_DISCOVERY_OP_MODE_STANDALONE;

            /// <summary>Discovery protocol has determined the device is a virtual device.</summary>
            literal k32s VIRTUAL        = GO_DISCOVERY_OP_MODE_VIRTUAL;

            /// <summary>Discovery protocol has determined the device is being accelerated by an accelerator host.</summary>
