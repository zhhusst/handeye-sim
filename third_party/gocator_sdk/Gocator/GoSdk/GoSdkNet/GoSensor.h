    ...
    namespace GoSdk
    {
        ...
        public ref class GoSensor : public KObject
        {
           ...
           /// <summary>Gets the model number associated with this sensor.</summary>
            ...
            /// GOC-14715: Add laser shut off support to C# SDK wrapper.
            /// <summary>Turns the laser on or off.</summary>
            ///
            /// <param name="value">non zero value turns laser on, zero value turns laser off</param>
            void SetLaserState(k8u value)
            {
                KCheck(::GoSensor_SetLaserState(Handle, value));
            }

            // GOC-15175: Add shutdown support to C# SDK wrapper.
            /// <summary>Shuts down the sensor.</summary>
            void Shutdown()
            {
                KCheck(::GoSensor_Shutdown(Handle));
            }

            // GOC-15340: Add laser safety support to C# SDK wrapper.
            /// <summary>Turns laser safety on or off.</summary>
            ///
            /// <param name="value">non zero value enables laser safety, zero value turns it off.</param>
            void SetLaserSafety(bool value)
            {
                KCheck(::GoSensor_LockOutLaser(Handle, value));
            }
