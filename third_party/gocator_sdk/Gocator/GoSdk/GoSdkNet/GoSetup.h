    ...
    namespace GoSdk
    {
        ...
        public ref class GoSetup : public KObject
        {
           ...
           /// <summary>The external input to use for profile triggering - only applicable if trigger source is DigitalInput.</summary>
            ...
            /// <summary>Returns whether the device supports enhanced surface flatness filtering or not.</summary>
            ///
            /// <param name="role">Determines which device to retrieve the value from. Use GoRole.Main or GoRole.Buddy + buddyidx. See GoRole for more details.</param>
            bool IsEnhancedSurfaceFlatnessFilterSupported(GoRole role)
            {
                return KToBool(::GoSetup_IsEnhancedSurfaceFlatnessFilterSupported(Handle, role));
            }

            /// <summary>Enables/disables use of enhanced surface flatness filtering.</summary>
            ///
            /// <param name="role">Determines which device to retrieve the value from. Use GoRole.Main or GoRole.Buddy + buddyidx. See GoRole for more details.</param>
            /// <param name="enable">Whether to enable or disable enhanced surface flatness.</param>
            void EnableEnhancedSurfaceFlatnessFilter(GoRole role, bool enable)
            {
                return KCheck(::GoSetup_EnableEnhancedSurfaceFlatnessFilter(Handle, role, enable));
            }

            /// <summary>Selects one of the builtin enhanced surface flatness filters to use.</summary>
            ///
            /// <param name="role">Determines which device to retrieve the value from. Use GoRole.Main or GoRole.Buddy + buddyidx. See GoRole for more details.</param>
            /// <param name="type">Selects the enhanced surface flatness filter type to use. A value of "Disabled" is not allowed. To disable enhanced surface flatness filtering, use the DisablePrefilter() API.</param>
            /// <param name="length">Selects the number of coefficient the enhanced surface flatness filter will use.</param>
            void SelectBuiltInEnhancedSurfaceFlatnessFilter(GoRole role, GoPreFilterType type, GoPreFilterLengthOption length)
            {
                return KCheck(::GoSetup_SelectBuiltInEnhancedSurfaceFlatnessFilter(Handle, role, type, length));
            }

            /// <summary>Selects using custom enhanced surface flatness filter where the enhanced surface flatness filter coefficients are supplied by the user.</summary>
            ///
            /// <param name="role">Determines which device to retrieve the value from. Use GoRole.Main or GoRole.Buddy + buddyidx. See GoRole for more details.</param>
            /// <param name="length">Selects the number of coefficient the enhanced surface flatness filter will use.</param>
            /// <param name="coefficientsArray">Input array containing the enhanced surface flatness filter coefficients for the device to use.</param>
            void SelectCustomEnhancedSurfaceFlatnessFilter(GoRole role, GoPreFilterLengthOption length, array<k64f>^ coefficientsArray)
            {
                // Make sure the number of coefficients in the array is consistent with the number of coefficients option parameter.
                KCheckArgs(length == coefficientsArray->Length);

                // Create a pinned pointer to one element of the managed object array to pin the entire array.
                // Pinning the managed object is necessary to prevent managed object from be garbage collected while the C-SDK is using it.
                pin_ptr<k64f> pinnedCoefficientsPtr = &(coefficientsArray[0]);
                // Now create a native, unmanaged, pointer to the array for the C-SDK API to use.
                k64f* coefficientsPtr = (k64f*) pinnedCoefficientsPtr;

                return KCheck(::GoSetup_SelectCustomEnhancedSurfaceFlatnessFilter(Handle, role, length, coefficientsPtr));
            }

            /// <summary>Checks if enhanced surface flatness is enabled.</summary>
            ///
            /// <param name="role">Determines which device to retrieve the value from. Use GoRole.Main or GoRole.Buddy + buddyidx. See GoRole for more details.</param>
            /// <returns>The enhanced surface flatness filter type from the device.</returns>
            bool EnhancedSurfaceFlatnessFilterEnabled(GoRole role)
            {
                return KToBool(::GoSetup_EnhancedSurfaceFlatnessFilterEnabled(Handle, role));
            }

            /// <summary>Gets the current enhanced surface flatness filter type that has been selected.</summary>
            ///
            /// <param name="role">Determines which device to retrieve the value from. Use GoRole.Main or GoRole.Buddy + buddyidx. See GoRole for more details.</param>
            /// <returns>The enhanced surface flatness filter type from the device.</returns>
            GoPreFilterType EnhancedSurfaceFlatnessFilterType(GoRole role)
            {
                return (GoPreFilterType) ::GoSetup_EnhancedSurfaceFlatnessFilterType(Handle, role);
            }

            /// <summary>Gets the length of the enhanced surface flatness filter the device is using.</summary>
            ///
            /// <param name="role">Determines which device to retrieve the value from. Use GoRole.Main or GoRole.Buddy + buddyidx. See GoRole for more details.</param>
            /// <returns>The length of enhanced surface flatness filter the device is set to use.</returns>
            GoPreFilterLengthOption EnhancedSurfaceFlatnessFilterLength(GoRole role)
            {
                return (GoPreFilterLengthOption) ::GoSetup_EnhancedSurfaceFlatnessFilterLength(Handle, role);
            }

            /// <summary>Gets the enhanced surface flatness filter coefficients used by the enhanced surface flatness filter.</summary>
            ///
            /// <param name="role">Determines which device to retrieve the value from. Use GoRole.Main or GoRole.Buddy + buddyidx. See GoRole for more details.</param>
            /// <returns>Output array containing the enhanced surface flatness filter cofficients used by the device's enhanced surface flatness filter.</returns>
            array<k64f>^ EnhancedSurfaceFlatnessFilterFilterCoefficients(GoRole role)
            {
                GoPreFilterLengthOption length = GoSetup_EnhancedSurfaceFlatnessFilterLength(Handle, role);
                array<k64f>^ coefficients = gcnew array<k64f>((int)length);
                // Create a pinned pointer to one element of the managed object array to pin the entire array.
                // Pinning the managed object is necessary to prevent managed object from be garbage collected while C-code is
                // copying data into it.
                pin_ptr<k64f> pin = &coefficients[0];
                // Now create a native, unmanaged, pointer to the destination array for the C-SDK API to use.
                k64f* native = (k64f*)pin;

                // Get the source of coefficients.
                const k64f* src = ::GoSetup_EnhancedSurfaceFlatnessFilterCoefficients(Handle, role);

                // During this copy, the pinned pointer ensures the destination doesn't get moved by the C# garbage collector.
                KCheck(kMemCopy(native, src, (length * sizeof(k64f))));

                return coefficients;
            }

            /// <summary>Gets the smallest allowable enhanced surface flatness filter coefficient.</summary>
            ///
            /// <param name="role">Determines which device to retrieve the value from. Use GoRole.Main or GoRole.Buddy + buddyidx. See GoRole for more details.</param>
            /// <returns>The smallest allowable enhanced surface flatness filter coefficient.</returns>
            k64f EnhancedSurfaceFlatnessFilterCoefficientMinValue(GoRole role)
            {
                return ::GoSetup_EnhancedSurfaceFlatnessFilterCoefficientMinValue(Handle, role);
            }

            /// <summary>Gets the largest allowable enhanced surface flatness filter coefficient.</summary>
            ///
            /// <param name="role">Determines which device to retrieve the value from. Use GoRole.Main or GoRole.Buddy + buddyidx. See GoRole for more details.</param>
            /// <returns>The largest allowable enhanced surface flatness filter coefficient.</returns>
            k64f EnhancedSurfaceFlatnessFilterCoefficientMaxValue(GoRole role)
            {
                return ::GoSetup_EnhancedSurfaceFlatnessFilterCoefficientMaxValue(Handle, role);
            }

            /// <summary>Gets the expected value of the sum of all the enhanced surface flatness filter coefficients.</summary>
            ///
            /// <param name="role">Determines which device to retrieve the value from. Use GoRole.Main or GoRole.Buddy + buddyidx. See GoRole for more details.</param>
            /// <returns>The expected sum of all enhanced surface flatness filter coefficients used in the enhanced surface flatness filter.</returns>
            k64f EnhancedSurfaceFlatnessFilterCoefficientsExpectedSum(GoRole role)
            {
                return ::GoSetup_EnhancedSurfaceFlatnessFilterCoefficientsExpectedSum(Handle, role);
            }
            ...
            /// <summary>Returns whether the value used for the x-resolution divider is the one set by the user or the system default value.</summary>
            ///
            /// <param name="role">Determines which device to retrieve the value from. Use GoRole.Main or GoRole.Buddy + buddyidx. See GoRole for more details.</param>
            bool GetXSubsamplingUsed(GoRole role)
            {
                return KToBool(::GoSetup_XSubsamplingUsed(Handle, role));
            }

            /// <summary>Gets the x-resolution divider system value.</summary>
            ///
            /// <param name="role">Determines which device to retrieve the value from. Use GoRole.Main or GoRole.Buddy + buddyidx. See GoRole for more details.</param>
            k32u GetXSubsamplingSystemValue(GoRole role)
            {
                return ::GoSetup_XSubsamplingSystemValue(Handle, role);
            }

            /// <summary>Returns whether the sensor has a x-resolution divider default value or not.</summary>
            ///
            /// <param name="role">Determines which device to retrieve the value from. Use GoRole.Main or GoRole.Buddy + buddyidx. See GoRole for more details.</param>
            bool GetXSubsamplingDefaultEnabledUsed(GoRole role)
            {
                return KToBool(::GoSetup_XSubsamplingDefaultEnabledUsed(Handle, role));
            }

            /// <summary>Sets whether to use the sensor's default x-resolution divider or the user-selected divider.</summary>
            ///
            /// <param name="role">Determines which device to apply changes to. Use GoRole.Main or GoRole.Buddy + buddyidx. See GoRole for more details.</param>
            /// <param name="useDefault">Determines whether to use default x-resolution divider (true) or current one set by the user (false).</param>
            void SetXSubsamplingDefaultEnabled(GoRole role, kBool useDefault)
            {
                KCheck(::GoSetup_SetXSubsamplingDefaultEnabled(Handle, role, useDefault));
            }

            /// <summary>Returns whether the x-resolution divider default is being used.</summary>
            ///
            /// <param name="role">Determines which device to retrieve the value from. Use GoRole.Main or GoRole.Buddy + buddyidx. See GoRole for more details.</param>
            bool GetXSubsamplingDefaultEnabled(GoRole role)
            {
                return KToBool(::GoSetup_XSubsamplingDefaultEnabled(Handle, role));
            }
            ...
            /// <summary>Returns whether the value used for the z-resolution divider is the one set by the user or the system default value.</summary>
            ///
            /// <param name="role">Determines which device to retrieve the value from. Use GoRole.Main or GoRole.Buddy + buddyidx. See GoRole for more details.</param>
            bool GetZSubsamplingUsed(GoRole role)
            {
                return KToBool(::GoSetup_ZSubsamplingUsed(Handle, role));
            }

            /// <summary>Gets the z-resolution divider system value.</summary>
            ///
            /// <param name="role">Determines which device to retrieve the value from. Use GoRole.Main or GoRole.Buddy + buddyidx. See GoRole for more details.</param>
            k32u GetZSubsamplingSystemValue(GoRole role)
            {
                return ::GoSetup_ZSubsamplingSystemValue(Handle, role);
            }

            /// <summary>Returns whether the sensor has a z-resolution divider default value or not.</summary>
            ///
            /// <param name="role">Determines which device to retrieve the value from. Use GoRole.Main or GoRole.Buddy + buddyidx. See GoRole for more details.</param>
            bool GetZSubsamplingDefaultEnabledUsed(GoRole role)
            {
                return KToBool(::GoSetup_ZSubsamplingDefaultEnabledUsed(Handle, role));
            }

            /// <summary>Sets whether to use the sensor's default z-resolution divider or the user-selected divider.</summary>
            ///
            /// <param name="role">Determines which device to apply changes to. Use GoRole.Main or GoRole.Buddy + buddyidx. See GoRole for more details.</param>
            /// <param name="useDefault">Determines whether to use default z-resolution divider (true) or current one set by the user (false).</param>
            void SetZSubsamplingDefaultEnabled(GoRole role, kBool useDefault)
            {
                KCheck(::GoSetup_SetZSubsamplingDefaultEnabled(Handle, role, useDefault));
            }

            /// <summary>Returns whether the z-resolution divider default is being used.</summary>
            ///
            /// <param name="role">Determines which device to retrieve the value from. Use GoRole.Main or GoRole.Buddy + buddyidx. See GoRole for more details.</param>
            bool GetZSubsamplingDefaultEnabled(GoRole role)
            {
                return KToBool(::GoSetup_ZSubsamplingDefaultEnabled(Handle, role));
            }
            ...
            /// <summary>Gets/Sets the transmit limit of the system (% of max).</summary>
            property k32u TransmitLimit
            {
                k32u get() { return ::GoSetup_TransmitLimit(Handle); }
                void set(k32u val) { KCheck(::GoSetup_SetTransmitLimit(Handle, val)); }
            }
