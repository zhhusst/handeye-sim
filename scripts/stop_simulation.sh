...
TARGET_PATTERNS=(
    ...
    "^/usr/bin/python3 /workspace/ros2_ws/install/handeye_sim_bridge/lib/handeye_sim_bridge/(scene_publisher_node|profile_endpoint_detector|srdf_publisher_node|profile_viz|seed_collection|active_calibration_sim)( |$)"
