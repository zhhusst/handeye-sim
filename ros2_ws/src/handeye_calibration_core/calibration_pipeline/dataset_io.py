...
def result_payload(result, *, extra: dict | None = None) -> dict:
    ...
    payload = {
        ...
        "diagnostics": {
            # Backward-compatible top-level values are data-only in newly
            # written results. The nested objects make the split explicit.
            ...
            "data_only": {
                ...
                "singular_values": (
                    result.diagnostics.singular_values.tolist()
                ),
            },
            "prior_augmented": {
                "rank": int(
                ...
                "singular_values": (
                    result.diagnostics.prior_augmented_singular_values.tolist()
                    if result.diagnostics.prior_augmented_singular_values
                    is not None
